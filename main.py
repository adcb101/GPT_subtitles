...
class SubtitleProcessor:
    ...
    def transcribe_audio(self,file_name):
        ...
        srt_file = os.path.join(os.path.dirname(self.video_path), f'{file_name}.srt')
        with open(srt_file, 'w') as f:
            f.write(srt_sub)

        # Original whisper segmentation
        srt_sub = self.segments_to_srt(sentence_list)
        original_srt_file = os.path.join(os.path.dirname(self.video_path), f'{file_name}_original.srt')
    ...
    def process(self):
        ...
        transcript, srt_file = self.transcribe_audio(self.file_name)
