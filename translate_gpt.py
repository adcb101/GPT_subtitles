...
def translate_with_gpt(input_file, target_language='zh', source_language='en', batch_size=40, model='gpt-3.5-turbo-16k', video_info=None, no_translation_mapping=False, load_from_tmp=False):
    ...
    str_list = [
               '/kaggle/input/3subtit/1.10 - Borrow Rate, Short Shares, Synthetic Short Shares.srt',
               '/kaggle/input/3subtit/1.11 - Micro Structure and Market Making.srt',
               '/kaggle/input/3subtit/1.12 - What are Banana Flows (Vanna flow in-depth discussion).srt',
               '/kaggle/input/3subtit/1.13 - Reviewing Our Trade on LIT Calculating the Volatility of an ETF.srt',
               '/kaggle/input/3subtit/1.14 - Relative Value.srt',
               '/kaggle/input/3subtit/1.2 - Volatility as Synthetic Time.srt',
               '/kaggle/input/3subtit/1.3 - Understanding Forward Volatility.srt',
               '/kaggle/input/3subtit/1.4 - Term Structure and Forward Volatility.srt',
               '/kaggle/input/3subtit/1.5 - Volatility Through Time Forward Volatility Calendar Spreads.srt',
               '/kaggle/input/3subtit/1.6 - What is Variance Risk Premium in depth.srt',
               '/kaggle/input/3subtit/1.7 - How to determine the Vol line you are selling (Illiquid Products).srt',
               '/kaggle/input/3subtit/1.8 - Stock Price and Implied Volatility Correlations.srt',
               '/kaggle/input/3subtit/1.9 - Introduction to Synthetics.srt',
               '/kaggle/input/3subtit/2.1 - 2 Ways to Value an Option (Absolute and Relative).srt',
               '/kaggle/input/3subtit/2.10 - Relative Value Trading Pt 1.srt',
               '/kaggle/input/3subtit/2.11 - Relative Value Trading Pt 2.srt',
               '/kaggle/input/3subtit/2.12 - Managing Relative Value Positions.srt',
               '/kaggle/input/3subtit/2.13 - Building a Technical Strategy.srt',
               '/kaggle/input/3subtit/2.2 - Finding and Placing Excellent Trades (Start to Finish).srt',
               '/kaggle/input/3subtit/2.3 - How to Trade in a Lower Volatility Environment.srt',
               '/kaggle/input/3subtit/2.4 - How Calendar Spreads Work and Understanding Volatility Through Time.srt',
               '/kaggle/input/3subtit/2.5 - How to Trade Forward Volatility.srt',
               '/kaggle/input/3subtit/2.6 - Interview with a Profitable Earnings Trader.srt',
               '/kaggle/input/3subtit/2.7 - Constructing a Portfolio and Improving Your Sharpe Ratio.srt',
               '/kaggle/input/3subtit/2.8 - Earnings Pre-Releases - Unique Trading Opportunities.srt',
               '/kaggle/input/3subtit/2.9 - Earnings Pre Releases and How to Trade Them.srt'
    ]
